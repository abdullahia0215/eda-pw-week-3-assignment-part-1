...
let favoriteFoods = ['empanadas', 'samosas', 'chicken tikki masala'];
...
let lastAnimalGrab = animalArray.length - 1;
let lastAnimal = animalArray[lastAnimalGrab];
...
let gemToAdd = 'Tourmaline';
gems.splice(1, 1, gemToAdd);
